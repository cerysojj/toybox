...
This repository contains code for experiments on training CNNs with infant-inspired curricula. Using a blurry-to-clear training curriculum, this project examines how early exposure to blur and instance-level learning shape robustness to blur across domains (faces vs. objects) and classification levels (instance vs. category).
